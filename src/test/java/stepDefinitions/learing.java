...
//    String URL = "https://app.checktrack.dev/#/login";
    String IDpass = "mihirpatel@yopmail.com";
...
//    		File file = new File("D:\\Download\\payslip_January_2025.pdf"); // for fail
    	...
    	@Test
        public void timezoneselection() throws IOException, InterruptedException {
    		...
    		WebElement scrollable = driver.findElement(By.xpath("//flt-semantics-container[contains(@style,'overflow-y: hidden')]"));

    		JavascriptExecutor js = (JavascriptExecutor) driver;
    		for (int i = 0; i < 5; i++) {
    		    js.executeScript("arguments[0].scrollBy(0, 100)", scrollable); // simulate scroll
    		    Thread.sleep(300);
    		}


//    		driver.findElement(By.xpath("//flt-semantics[@aria-label='America/New_York']")).click();Thread.sleep(1000);
